        ...
        <div class="col-main">
            <div class="row">
                <div class="product-view">
                                                ...
                                                <div class="">
                                                    <div class="">
                                                        <div class="">
                                                            ...
                                                            ?>
                                                                <button class="sizeProduct" quantitySize="<?= $value['quantity'] ?>" detailSizeProduct="<?= $value['name_size'] ?>" style="width: 50px; height: 30px;outline: none; background:white; border : 1px #ddd solid;text-align: center; <?php if ($value['quantity'] == 0) {
                                                                                                                                                                                                                                                                                                        echo "color:#ddd";
                                                                                                                                                                                                                                                                                                    } ?>" <?php if ($value['quantity'] == 0) {
                                                                                                                                                                                                                                                                                                                echo "disabled";
                                                                                                                                                                                                                                                                                                            } ?>><?= $value['name_size'] ?></button>
                                                            <?php
                                                            }
                                                            ?>
                    ...
                    <div class="product-collateral col-sm-12 col-xs-12 bounceInUp animated">
                        <div class="add_info">
                            <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                                ...
                                <li> <a href="#product_tabs_custom" id="load_comment" product_id="<?php if (isset($_GET['id']) && !empty($_GET['id'])) {
                                                                                                        echo $_GET['id'];
                    ...
                    <?php
                    if (isset($selectAllSetProduct) && !empty($selectAllSetProduct)) {
                    ?>
                        <div class="related-slider col-lg-12 col-xs-12 bounceInDown animated">
                            <div class="slider-items-products">
                                <div class="slider-items-products">
                                    <div class="new_title center">
                                        <h2>Set đồ theo sản phẩm</h2>
                                    </div>
                                    <div id="related-products-slider" class="product-flexslider hidden-buttons">
                                        <div class="slider-items slider-width-col4 products-grid">
                                            <?php

                                            foreach ($selectAllSetProduct as $value) {
                                            ?>
                                                <div class="item">
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="Sample Product" style="width:265px ; height: 321px;" src="assets/images/products/<?= $value['main_image'] ?>"> </a>
                                                                ...
                                                                <div class="item-box-hover">
                                                                    <div class="box-inner">
                                                                        <div class="actions">
                                                                            ...
                                                                            <span class="add-to-links"> <a class="link-wishlist" product_id="<?= $value['id'] ?>" title="Add to Wishlist"><span>Add to Wishlist</span></a> <a href="compare.html" class="link-compare add_to_compare" title="Add to Compare"><span>Add to Compare</span></a></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="item-info">
                                                            <div class="info-inner">
                                                                <div class="item-title"> <a title="Sample Product" href="product_detail.html"> <?= $value['name'] ?> </a> </div>
                                                                <div class="item-content">
                                                                    ...
                                                                    <div class="item-price">
                                                                        <div class="price-box"> <span class="regular-price"> <span class="price"><?php echo number_format($value['price'], 0, '', '.'); ?> ₫</span> </span> </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<?php
if (isset($selectAllCateProduct) && !empty($selectAllCateProduct)) {
?>
    <section class="upsell-pro bounceInUp animated">
        <div class="container">
            <div class="slider-items-products">
                <div class="new_title center">
                    <h2>Sảm phẩm liên quan</h2>
                </div>
                <div id="upsell-products-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col4 products-grid">

                        <?php
                        foreach ($selectAllCateProduct as $value) {
                        ?>
                            <div class="item">
                                <div class="item-inner">
                                    <div class="item-img">
