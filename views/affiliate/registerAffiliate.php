						...
						<form action="" method="POST" enctype="multipart/form-data">
							...
							<div class="wizard-footer">
								<div class="pull-right">
									...
									<input type="submit" class='btn btn-finish btn-fill btn-success btn-wd' name="finish" value="Hoàn thành" />
								</div>

								<div class="pull-left">
									<input type='button' class='btn btn-previous btn-fill btn-default btn-wd' name='previous' value='Trước' />
								</div>
