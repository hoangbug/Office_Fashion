         ...
         <article class="col-main">
           ...
           <div class="category-products">
             <ul class="products-grid">
               <?php
               if (!empty($getProductAllWomen)) {
                foreach ($getProductAllWomen as $value) {
                  ?>
                  <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                   <div class="item-inner">
                     <div class="item-img">
                       <div class="item-img-info"> <a href="index.php?page=product&method=productDetail&id=<?= $value['id']; ?>" title="Sample Product" class="product-image"> <img src="assets/images/products/<?= $value['main_image']; ?>" alt="Sample Product" style="width: 100%; height: 260.64px;"> </a>
...
<div class="toolbar">
  <div class="pager">
    ...
    <div class="pages">
      ...
      <ul class="pagination">
        <li style="<?php if ($pages <= 1) {echo 'display: none;';} ?>">
          <a href="<?php if ($pages <= 1) {echo "";} else { echo "index.php?page=".$page."&cate_id=".$cate_id."&pages=" . $prev;} ?>">&laquo;</a>
        </li>
        <?php for ($i = $start; $i <= $end; $i++) { ?>
          <li class="<?php if ($pages == $i) {echo "active";}?>">
            <a href="index.php?page=<?=$page?>&cate_id=<?=$cate_id?>&pages=<?= $i; ?>"><?php echo $i; ?></a>
          </li>
        <?php } ?>
        <li style="<?php if ($pages >= $count) {echo 'display: none;';} ?>">
          <a href="<?php if($pages >= $count){echo "";}else{ echo "index.php?page=".$page."&cate_id=".$cate_id."&pages=".$next;} ?>">&raquo;</a>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="pager">
    <div id="limiter">
      ...
      <ul class="pagination">
        <li style="<?php if ($pages <= 1) {echo 'display: none;';} ?>">
          <a href="<?php if ($pages <= 1) {echo "";} else { echo "index.php?page=men&pages=" . $prev;} ?>">&laquo;</a>
        </li>
        <?php for ($i = $start; $i <= $end; $i++) { ?>
          <li class="<?php if ($pages == $i) {echo "active";}?>">
            <a href="index.php?page=women&pages=<?= $i; ?>"><?php echo $i; ?></a>
          </li>
        <?php } ?>
        <li style="<?php if ($pages >= $count) {echo 'display: none;';} ?>">
          <a href="<?php if($pages >= $count){echo "";}else{ echo "index.php?page=men&pages=".$next;} ?>">&raquo;</a>
        </li>
      </ul>
    </div>
  </div>
