...
<section class="footer-navbar">
                ...
                <div class="col-sm-12 col-xs-12 col-lg-8">
                    ...
                    <div class="footer-column pull-left collapsed-block">
                        ...
                        <div class="tabBlock" id="TabBlock-2">
                            <ul class="links">
                                <li class="first"><a title="Your Account" href="login.html">Your Account</a>
                                </li>
    ...
    <div class="footer-middle">
        <div class="container">
            <div class="row">
                <!-- <div style="text-align:center"><a href="index.php"><img src="assets/images/footer-logo.png" alt="footer-logo"></a></div> -->
                <address>
                    <i class="icon-location-arrow"></i> 123 Main Street, Anytown, CA 12345 USA <i class="icon-mobile-phone"></i><span> +(408) 394-7557</span> <i class="icon-envelope"></i><a href="mailto:hoanghoe10062@gmail.com">hoanghoe10062@gmail.com</a>
                </address>
            </div>
        </div>
    </div>
