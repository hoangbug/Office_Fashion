                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="tab-pane" id="address">
                                    <div class="row">
                                        <div class="col-sm-12" style="background: #eee; padding-top: 22px; text-align: center;">
                                            <h4 class="info-text"> Chào mừng bạn đến với Fashion World</h4>
                                        ...
                                        <div class="col-sm-8 col-sm-offset-2" style="padding: 15px;">
                                            <div class="input-group">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input name="email" type="text" class="form-control" value="" style="font-size: 20px;">
                            ...
                            <div class="wizard-footer">
                                <div class="pull-right">
                                    <input type="submit" class='btn btn-finish btn-fill btn-success btn-wd' name="loginMember" value="Đăng nhập" />
                                </div>
                                <div class="clearfix">
                                    <a href="index.php?page=member&method=registerMember"><input class='btn btn-finish btn-fill btn-info btn-wd' value="Đăng ký" /></a>
                                </div>
                            </div>
                        </form>
                    </div>
