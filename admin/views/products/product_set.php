                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../assets/images/products/<?= $value['image_sets']; ?>" alt="" style="width: 100px; height: 100px;"></td>
                                <td><?php echo number_format($value['price'], 0, '', '.'); ?></td>
                                <!-- <td><?= $value['description']; ?></td> -->
                                <td><?= $value['sale']; ?></td>
                                <td><?= $value['views']; ?></td>
                                <td><?php if (($value['status']) == 0) {
                                        echo "<i class='ion ion-md-close-circle' style='color: red;font-size: 23px; padding: 10px; vertical-align: middle;'></i>Out of stock";
                                ...
                                <td><button type="button" product_set="<?= $value['id']; ?>" class="btn btn-info updateProductSet" data-toggle="modal" data-target="#updateProductSet" style="font-size: 23px;"><i class="ion ion-md-brush"></i></button></td>

                                <!-- <td><a href="#custom-modal" class="btn btn-primary waves-effect waves-light updateProductSet" product_set="<?= $value['id']; ?>" data-animation="push" data-plugin="custommodal" data-overlayspeed="100" data-overlaycolor="#36404a"><i class="ion ion-md-brush"></i></a></td> -->

                                <td><a href="index.php?page=product&method=product_set_delete&id_proset=<?= $value['id']; ?>&img=<?=$value['image_sets']?>" onclick="return confirm('Bạn có thực sự muốn xóa sản phẩm này không? ');" class="btn btn-danger" style="font-size: 23px;"><i class="ion ion-md-close-circle-outline"></i></a></td>
                            </tr>
                        <?php
                        }
                        ?>
...
<!-- Modal -->
<div class="modal fade bs-example-modal-center" id="updateProductSet" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
