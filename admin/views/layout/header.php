<div class="navbar-custom">
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="assets/images/users/<?php if (isset($_COOKIE['avatarUser'])) {
                                                        echo $_COOKIE['avatarUser'];
                                                    } ?>" alt="user-image" class="rounded-circle">
                    <span class="pro-user-name ml-1">
                        <?php if (isset($_COOKIE['nameUser'])) {
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <!-- item-->
                    <a href="index.php?page=account&method=logout" class="dropdown-item notify-item">
        ...
        <!-- LOGO -->
        <?php if(!empty($selectDecen)){ 
            foreach($selectDecen as $value){
                if($value['id'] == 7){ ?>
        ...
        <div class="list-group" id="list_search" style="position: absolute; top: 100%; left: 13.5%; width: auto;">
        </div>
